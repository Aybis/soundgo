...
const GAMES = [
  { to: "/learn/finger-math", emoji: "🖐️", title: "Finger Math", sub: "Show the right number of fingers!" },
  { to: "/learn/grab-answer", emoji: "✋", title: "Grab the Answer", sub: "Point & pinch your answer!" },
  { to: "/learn/air-writing", emoji: "✍️", title: "Air Writing", sub: "Trace letters in the air", soon: true },
  { to: "/learn/simon", emoji: "🧠", title: "Simon Says", sub: "Copy the moves!", soon: true },
];
